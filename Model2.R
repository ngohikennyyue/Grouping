...
student_fall2019 <- read_csv("https://raw.githubusercontent.com/ngohikennyyue/Grouping/master/Raw%20Data/Fall2019.csv")
...
Tab <- student_fall2019 %>% 
  ...
  dplyr::select(Name, Longitude, Latitude, Gender, Complex)
